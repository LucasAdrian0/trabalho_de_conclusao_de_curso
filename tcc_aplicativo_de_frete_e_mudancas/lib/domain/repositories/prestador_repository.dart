...
abstract class PrestadorRepository {
  ...
  Future<List<PrestadorEntity>> buscarDisponiveisPorRegiao(String cidade, String estado);
  Future<void> salvar(PrestadorEntity prestador);
  Future<void> atualizar(PrestadorEntity prestador);
  Future<void> alterarDisponibilidade(String usuarioId, StatusDisponibilidade disponivel);
}