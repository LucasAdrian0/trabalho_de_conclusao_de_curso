...
abstract class NotificacoesRemoteDataSource {
  ...
  Future<void> criar(NotificacoesModel notificacao);
}
...
class NotificacoesRemoteDataSourceImpl implements NotificacoesRemoteDataSource {
  ...
  @override
  Future<void> criar(NotificacoesModel notificacao) async {
    await supabase.from('notificacoes').insert(notificacao.toJson());
  }
}